                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div class="col-md-10 col-sm-10 col-xs-22" style="margin-left: 0%; width: 94%">
						<h1 class="lime-text darken-4">{{$proj->pi_title}}</h1>
					</div>
                      ...
                      <section class="panel">
                        ...
                        <div class="panel-body" style="margin-top:-27px;">
						  ...
						  @endforeach
							...
							<ul>
								<li><img src="images/profile/{{$proj->emp_image}}" class="avatar" alt="Avatar"> </li>
								<li style="margin-bottom:-2px">&nbsp;{{$proj->emp_first_name.' '.$proj->emp_middle_initial.' '.$proj->emp_last_name}}</li>
							</ul>
                          </div>
								...
								@foreach($task as $task)
									<tr>
										...
										<td style="text-align: center;">
											<span class="new badge @if ($task->pt_status=='Complete')  @elseif ($task->pt_status=='On Going') orange accent-3 @else lime lighten-5 grey-text @endif" data-badge-caption="" style="font-size:13px;">{{$task->pt_status}}</span>
										</td>
									</tr>
								@endforeach
								</tbody>
					...
					<div class="text-center">
                            @if($proj->proj_status != 'Closed')<a @if($proj->proj_status != 'Closed') href="/PM_project_edit?id={{$proj->proj_no}}" @endif class="btn edittype" style="width: 140px; height: 30px; font-size:15px;">Edit Details</a>@endif
                    </div>
					@endforeach
                  </div>

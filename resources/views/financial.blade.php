                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      <thead style="background-color: #353959; color:#ffffff;">
                        <tr>
                          <th>#</th>
                          <th style="width: 29%;">Project Description</th>
					  ...
					  @foreach($fin as $fin)
                        <tr>
                          ...
                          <td>
                            <a href="/downloadfinancial?id={{$fin->proj_no}}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Project Financial Report"><i class="fa fa-download"></i> Generate PDF</a>
                          </td>
                        </tr>
					  @endforeach
                      </tbody>

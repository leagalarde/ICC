                                                          ...
                                                          <div class="w3-animate-zoom x_panel ui-ribbon-container fixed_height_350 fixed_width_600" style=" background-color: #353959; color:#ffffff;">
                                                            <div class="x_content">
                                                              <div style="text-align: center; margin-bottom: 17px;">
                                                                ...
                                                                <p>Status: @if(strtotime($proj->proj_end_date) < strtotime("now") && $proj->proj_status!='Complete')<span style="color:red"> Delayed </span> 
                                                            ...
                                                            <div class="col-md-4 col-sm-4 col-xs-8 tile_stats_count">
                                                              ...
                                                              <div class="count green"><strong @php $date = date_diff(date_create("now"),date_create($proj->proj_end_date))->format('%r%a')@endphp @if($date < 1)style="color:red"> 0 @else > @php echo $date; @endphp @endif CD</strong></div>
                                                            </div>
                                                            <div class="col-md-4 col-sm-4 col-xs-8 tile_stats_count" >

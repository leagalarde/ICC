          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li>
                  <a href="{{ url ('indexAdmin') }}"><i class="fa fa-dashboard" style="margin-left:-55px; margin-bottom: 3px;"></i><br>Dashboard </a>
                </li>
                <li>
                  <a ><i class="fa fa-wrench" style="margin-left:-60px; margin-bottom: 3px;"></i><br>Maintenance <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="{{ url ('truck_category') }}">Equipment</a></li>
                  </ul>
                </li>
                <li>
                  <a><i class="fa fa-cubes" style="margin-left:-75px; margin-bottom: 3px;"></i> <br>Project Management <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                ...
                <li>
                 <a><i class="fa fa-money" style="margin-left:-75px; margin-bottom: 3px;"></i> <br>Billing <span class="fa fa-chevron-down"></span></a>
                 <ul class="nav child_menu">
                  <li><a href="{{ url ('project_financial') }}">Project Financial</a></li>
                </ul>
              </li>
              <li>
                <a ><i class="fa fa-truck" style="margin-left:-75px; margin-bottom: 3px;"></i> <br>Inventory <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
              ...
              <li>
                <a ><i class="fa fa-file-pdf-o jumbo" style="margin-left:-75px; margin-bottom: 3px;"></i> <br>Report <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="{{ url ('contract') }}">Manage Contract</a></li>
